        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-4xl bg-white/5 backdrop-blur-3xl border border-[#A020F0]/30 rounded-2xl p-4 md:p-6 shadow-[0_0_50px_rgba(160,32,240,0.3)] h-auto max-h-[90vh] flex flex-col overflow-hidden"
                  ...
                  >
                    <div className="flex-none mb-2 md:mb-4">
                      <button 
                        ...
                        className="flex items-center gap-1 md:gap-2 text-[#A020F0] text-sm md:text-base font-bold uppercase tracking-[1px] md:tracking-[2px] hover:text-white transition-colors"
                      >
                    ...
                    <div className="flex-1 flex flex-col overflow-hidden pt-2">
                      ...
                      <div className="flex-1 overflow-y-auto px-1 space-y-4 overscroll-contain touch-auto pb-20 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']" style={{ WebkitOverflowScrolling: 'touch' }}>
                        ...
                        <div className="space-y-1">
                          <label className="text-xs md:text-sm text-[#A020F0] font-black tracking-[1px] md:tracking-[2px] uppercase">Detalhes</label>
                          <textarea 
                            rows={2}
